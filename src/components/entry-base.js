...
/**
 * Create an entry static rendered function.
 *
 * @param {Object} opts           options object
 * @param {String} opts.Index     HBS template
 * @param {Object} opts.routes    React routes
 * @param {String} opts.basename  basename for static assets
 * @returns {Function}            static render function
 */
export default (opts) => {
  // Validation
  opts = opts || {};
  ["Index", "routes", "basename"].forEach((key) => {
